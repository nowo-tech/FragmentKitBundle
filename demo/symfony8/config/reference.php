 ...
 *     },
 * }
 * @psalm-type NowoFragmentKitConfig = array{
 *     enabled?: bool|Param, // When false, the bundle does not decorate fragment.handler. // Default: true
 *     fallback?: array{
 *         template?: scalar|Param|null, // Twig template rendered when a fragment fails and ignore_errors is true. Null or empty = return an empty string. // Default: "@NowoFragmentKitBundle/fragment_failure.html.twig"
 *     },
 *     sentry?: array{
 *         enabled?: bool|Param, // Report suppressed fragment failures to Sentry (requires sentry/sentry-symfony). // Default: true
 *         level?: "debug"|"info"|"warning"|"error"|"fatal"|Param, // Sentry severity: debug, info, warning, error, fatal. // Default: "warning"
 *     },
 * }
 ...
 *     nowo_fragment_kit?: NowoFragmentKitConfig,
