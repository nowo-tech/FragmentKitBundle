...
namespace Nowo\FragmentKitBundle\DependencyInjection\Compiler;
...
/**
 * Registers bundle Twig paths so application overrides win.
 */
final class TwigPathsPass implements CompilerPassInterface
{
    private const TWIG_NAMESPACE = 'NowoFragmentKitBundle';
    ...
    public function process(ContainerBuilder $container): void
    {
        ...
        if ($container->hasParameter('kernel.project_dir')) {
            ...
            if (is_string($projectDirParam)) {
                ...
                $overridePath = $projectDir . '/templates/bundles/NowoFragmentKitBundle';
